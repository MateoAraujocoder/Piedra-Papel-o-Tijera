...
document.addEventListener("DOMContentLoaded", function () {
    ...
    iniciarJuegoBtn.addEventListener("click", function () {
        ...
        // Verifica si hay datos previamente guardados en localStorage
        const jugadorGuardado = localStorage.getItem('jugador');
        const partidasGanadasGuardadas = localStorage.getItem('partidasGanadas');

        if (jugadorGuardado && partidasGanadasGuardadas) {
            jugador.nombre = jugadorGuardado;
            jugador.partidasGanadas = parseInt(partidasGanadasGuardadas);
        }
        ...
        const jugar = () => {
            while (continuarJugando) {
                ...
                // Guarda los datos actualizados del jugador en localStorage
